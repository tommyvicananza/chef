...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jotamolina-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/proba"
  #   chef.validation_client_name = "proba-validator"
  #   chef.validation_key_path = ".chef/proba-validator.pem"
  # end
end
